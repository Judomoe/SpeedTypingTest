...
export default function RegisterPage() {
  ...
  const Field = ({ label, type, value, set, placeholder, hint }) => (
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ background: '#131318', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 18, padding: 32 }}>
          ...
          <form onSubmit={handleSubmit}>
            <Field label="Username" type="text" value={username} set={setUsername} placeholder="speedtyper42" hint="3–20 characters, shown on leaderboard" />
            <Field label="Email" type="email" value={email} set={setEmail} placeholder="you@example.com" />
            <Field label="Password" type="password" value={password} set={setPassword} placeholder="••••••••" hint="Minimum 8 characters" />
